...
const Controller = () => {
      ...
      while (attempts > 0) {
        try {
          const response = await axios.get(
            "https://eye-tracker-sunbird-dashing.ngrok-free.app/calibrate"
          );
  ...
  const handleCaptureImage = async () => {
    try {
      const response = await axios.get(
        "https://eye-tracker-sunbird-dashing.ngrok-free.app/capture_snapshot",
        {
          responseType: "blob",
        }
      );
      ...
      const uploadResponse = await axios.post(
        "https://summary-sunbird-dashing.ngrok-free.app/upload_image",
        formData,
        {
          timeout: 10000,
        }
  ...
  const handleReset = async () => {
    ...
    const onConfirm = async () => {
      try {
        await axios.get("https://summary-sunbird-dashing.ngrok-free.app/reset");
